...
angular
    ...
    .controller('AddReviewController', ['$scope', 'CoffeeShop', 'Review', '$state', function ($scope, CoffeeShop, Review, $state) {
        $scope.action = 'Add';
        $scope.coffeeShops = [];
        $scope.selectedShop;
        $scope.review = {};
    ...
    .controller('DeleteReviewController', ['$scope', 'Review', '$state', '$stateParams', function ($scope, Review, $state, $stateParams) {
        Review
            .deleteById({
                id: $stateParams.id
            })
    ...
    .controller('EditReviewController', ['$scope', '$q', 'CoffeeShop', 'Review', '$stateParams', '$state', function ($scope, $q, CoffeeShop, Review, $stateParams, $state) {
        $scope.action = 'Edit';
        $scope.coffeeShops = [];
        $scope.selectedShop;
        $scope.review = {};
        ...
        $q.all([
            ...
            selectedShopIndex = coffeeShops.map(function (coffeeShop) {
    ...
    .controller('MyReviewsController', ['$scope', 'Review', function ($scope, Review) {
        ...
        $scope.$watch('currentUser.id', function (value) {
            ...
            $scope.reviews = Review.find({
                filter: {
                    where: {
                        publicherId: $scope.currentUser.id
                    },
                    include: [
                        'coffeeShop',
                        'reviewer'
