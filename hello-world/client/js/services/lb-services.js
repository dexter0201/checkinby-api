...
/**
 * @ngdoc object
 * @name lbServices.Variant
 * @header lbServices.Variant
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Variant` model.
 *
 * ## Example
 *
 * See
  ...
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        /**
        * @ngdoc property
        * @name lbServices.Variant#modelName
        * @propertyOf lbServices.Variant
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Variant`.
        */
